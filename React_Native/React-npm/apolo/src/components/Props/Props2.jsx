      ...
      <div className="flex justify-center items-center">
        <div className="w-[400px] h-[500px] border-2 border-white mt-[40px] ml-8 shadow-xl">
          <div className="flex justify-center">
            <img
              className="h-[250px] w-[380px] rounded-lg -translate-y-3 shadow-2xl"
        ...
        <div className="w-[400px] h-[500px] border-2 border-white mt-[40px] ml-8 shadow-xl">
          <div className="flex justify-center">
            <img
              className="h-[250px] rounded-lg -translate-y-6 shadow-2xl"
        ...
        <div className="w-[400px] h-[500px] border-2 border-white mt-[40px] ml-8 shadow-xl">
          <div className="flex justify-center">
            <img
              className="h-[250px] shadow-2xl rounded-lg"
